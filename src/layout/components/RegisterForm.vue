    ...
    <div class="register-form">
        <el-form :model="formData" :rules="rules" ref="formRef">
            ...
            <el-form-item prop="nickName">
                <el-input clearable placeholder="请输入昵称" v-model="formData.nickName" :max-length="20">
                    <template #prefix>
                        <span class="iconfont icon-account"></span>
                    </template>
                </el-input>
            ...
            <div class="ohter-options">
                <el-button link type="primary" @click="handleOption()">已有账号</el-button>
            </div>
            <el-form-item>
...
import { register } from '@/api/loginAndRegister.js'
...
const getEmailCode = () => {
    formRef.value.validateField('email', (v) => {
        ...
        sendCode.value.showEmailCodeDialog(formData.email, 0)
    })
}
